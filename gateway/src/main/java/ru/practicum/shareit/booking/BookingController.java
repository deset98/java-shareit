...
public class BookingController {
    ...
    @PostMapping
    public ResponseEntity<Object> createBooking(@RequestHeader(Headers.USER_ID) long userId,
    ...
    @GetMapping
    public ResponseEntity<Object> getListByUser(@RequestHeader(Headers.USER_ID) long userId,
